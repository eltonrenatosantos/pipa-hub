...
<footer class="footer">
  ...
  <div class="footer-icons">
    ...
    <!-- Eventos -->
    <div class="nav-item" data-page="events" data-href="/pages/home.html">
    ...
    <!-- Mapa -->
    <div class="nav-item" data-page="map" data-href="/pages/map.html">
    ...
    <!-- Divulgar evento -->
    <div class="nav-item center" data-page="publish" data-href="/pages/publish.html">
      <div class="icon icon-plus">
        <span class="footer-plus-sweep"></span>
        <span class="footer-plus-core"></span>
        <span class="footer-plus-inner-ring"></span>
    ...
    <!-- Ranking -->
    <div class="nav-item" data-page="ranking" data-href="/pages/ranking.html">
    ...
    <!-- Perfil -->
    <div class="nav-item" data-page="profile" data-href="/pages/profile.html">
